...
map1 + tm_view(set.view = c(-71.5, 42.5, 7.4))
...
map2 + tm_view(set.view = c(-71.5, 42.5, 7.4))
...
map3 + tm_view(set.view = c(-71.5, 42.5, 7.4))
```
...
map4 + tm_view(set.view = c(-71.5, 42.5, 7.4))
...
map5 + tm_view(set.view = c(-71.5, 42.5, 7.4))
...
map6 + tm_view(set.view = c(-71.5, 42.5, 7.4))
```
...
gt_fig = gt_fig %>%
  plot_ly(
    ...
    type = 'scatter',
    mode = 'lines', 
    line = list(simplyfy = F)) %>% layout(
  xaxis = list(
    title = "Date",
    zeroline = F),
  yaxis = list(
    title = "Median",
    zeroline = F)) %>% animation_opts(
  frame = 100, 
  transition = 0, 
  redraw = TRUE) %>% animation_slider(
  hide = T) %>% animation_button(
